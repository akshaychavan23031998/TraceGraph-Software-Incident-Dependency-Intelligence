...
export function ErrorState({ retry }: { retry: () => void }) {
  return (
    <div className="panel flex min-h-72 flex-col items-center justify-center px-6 text-center">
      ...
      <h2 className="text-lg font-semibold text-white">Unable to load TraceGraph data</h2>
      <p className="mt-2 max-w-md text-sm leading-6 text-slate-400">The service and incident data could not be reached. Check the connection and try again.</p>
